    ...
    <div v-if="showDialog" class="dialog">
      <div class="dialog-content">
        ...
        <div class="actions border-t pt-4 mt-auto">
          <button @click="saveChanges" :disabled="!editEvent.title || !editEvent.start || !editEvent.end" class="btn-save">
            💾 {{ editEvent.id ? 'Save Changes' : 'Add Event' }}
          </button>
          <button v-if="editEvent.id" @click="deleteEvent" class="btn-delete">
            🗑 Delete
          </button>
